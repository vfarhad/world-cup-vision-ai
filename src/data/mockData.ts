...
export const mockRoundOf32 = [
  ...
  },
  {
    ...
    venue: "AT&T Stadium, Dallas",
    result: "",
    winnerAdvancesTo: "Round of 16 - Match 2",
    prediction: {
      home: 75,
      draw: 15,
      away: 10,
      projectedWinner: "England",
      comment: "England should have too much quality for Qatar in this matchup."
    }
  },
  {
    matchNumber: 4,
    ...
    time: "20:00",
    homeTeam: "Mexico",
    homeQualification: "Runner-up Group A",
    awayTeam: "Canada",
    awayQualification: "Best 3rd Place Group K",
    venue: "Estadio Azteca, Mexico City",
    result: "",
    winnerAdvancesTo: "Round of 16 - Match 2",
    prediction: {
      ...
      draw: 30,
      away: 15,
      projectedWinner: "Mexico",
      comment: "Home advantage for Mexico in Azteca will be a significant factor."
    }
  },
  {
    matchNumber: 5,
    ...
    time: "17:00",
    homeTeam: "Argentina",
    homeQualification: "Winner Group C",
    awayTeam: "Denmark",
    awayQualification: "3rd Place Group F",
    venue: "Hard Rock Stadium, Miami",
    result: "",
    winnerAdvancesTo: "Round of 16 - Match 3",
    prediction: {
      home: 65,
      draw: 20,
      away: 15,
      projectedWinner: "Argentina",
      comment: "Argentina's tournament experience should see them through against Denmark."
    }
  },
  {
    matchNumber: 6,
    ...
    time: "20:00",
    homeTeam: "France",
    homeQualification: "Winner Group D",
    awayTeam: "South Korea",
    awayQualification: "Best 3rd Place Group E",
    venue: "SoFi Stadium, Los Angeles",
    result: "",
    winnerAdvancesTo: "Round of 16 - Match 3",
    prediction: {
      ...
      comment: "France's depth and quality should overcome South Korea's organization."
    }
  }
];

// Mock Round of 16
export const mockRoundOf16 = [
  {
    matchNumber: 1,
    date: "July 3, 2026",
    time: "17:00",
    homeTeam: "USA",
    homeQualification: "Winner R32 Match 1",
    awayTeam: "Brazil",
    awayQualification: "Winner R32 Match 2",
    venue: "MetLife Stadium, New York",
    result: "",
    winnerAdvancesTo: "Quarter-final 1",
    prediction: {
      home: 30,
      draw: 25,
      away: 45,
      projectedWinner: "Brazil",
      comment: "A challenging match for the hosts against the South American giants."
    }
  },
  {
    matchNumber: 2,
    ...
    time: "20:00",
    homeTeam: "England",
    homeQualification: "Winner R32 Match 3",
    awayTeam: "Mexico",
    awayQualification: "Winner R32 Match 4",
    venue: "Rose Bowl, Los Angeles",
    result: "",
    winnerAdvancesTo: "Quarter-final 1",
    prediction: {
      ...
      away: 20,
      projectedWinner: "England",
      comment: "England's strength in depth should give them an edge in this encounter."
    }
  },
  {
    matchNumber: 3,
    ...
    time: "17:00",
    homeTeam: "Argentina",
    homeQualification: "Winner R32 Match 5",
    awayTeam: "France",
    awayQualification: "Winner R32 Match 6",
    venue: "AT&T Stadium, Dallas",
    result: "",
    winnerAdvancesTo: "Quarter-final 2",
    prediction: {
      home: 45,
      draw: 30,
      away: 25,
      projectedWinner: "Argentina",
      comment: "A rematch of the 2022 final that could go either way; slight edge to Argentina."
    }
  },
  {
    matchNumber: 4,
    ...
    time: "20:00",
    homeTeam: "Netherlands",
    homeQualification: "Winner R32 Match 7",
    awayTeam: "Portugal",
    awayQualification: "Winner R32 Match 8",
    venue: "Levi's Stadium, San Francisco",
    result: "",
    winnerAdvancesTo: "Quarter-final 2",
    prediction: {
      ...
      draw: 30,
      away: 30,
      projectedWinner: "Netherlands",
      comment: "A very even match between two technically gifted European sides."
    }
  }
];
